...
function typeIsLiteral(type) {
  if (import_semver.default.lt(import_typescript18.default.version, '5.0.0')) {
    return isTypeFlagSet(
      type,
      import_typescript18.default.TypeFlags.StringLiteral |
        import_typescript18.default.TypeFlags.NumberLiteral |
        import_typescript18.default.TypeFlags.BigIntLiteral
    );
  } else {
